                ...
                <div class="col-lg-9">
                    ...
                    <div class="tw-flex tw-justify-between tw-items-center">
                            <div class="lg:tw-mb-4">
                                <h5 class="tw-mb-0 tw-text-[#18191C] tw-text-2xl tw-font-medium">{{ __('My Profile') }}</h5>
                            </div>
                        ...
                        <!-- <div class="breadcrumbs breadcrumbs-height">
                            <div class="container">
                                <div class="breadcrumb-menu">
                                    <h6 class="f-size-18 m-0">{{ __('My ') }}</h6>
                                    <ul>
                                            ...
                                            <div class="card-body">
                                                <div class="rt-single-icon-box flex-column tw-items-center tw-gap-5 tw-justify-center flex-lg-row">
                                                    <div class="icon-thumb rt-mb-lg-20 company-logo !tw-m-0">
                                                        <img src="{{ $user->company->logo_url }}" alt="" draggable="false" class="object-fit-contain">
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="rt-single-icon-box">
                                                        <div class="icon-thumb company-logo">
                                                            <img src="{{ $job->company->logo_url }}" alt="" draggable="false" class="object-fit-contain">
                                                        </div>
                                                        <div class="iconbox-content">
