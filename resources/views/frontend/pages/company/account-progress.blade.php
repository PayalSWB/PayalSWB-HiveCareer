                ...
                <div class="container">
                    <div class="row w-100 tw-py-4">
                        <div class="col-sm-12 col-md-6 tw-text-center">
                            <a href="{{ route('website.home') }}" class="brand-logo tw-flex md:tw-justify-start tw-justify-center tw-items-center">
                ...
                <div id="msform">
                    @if (!auth()->user()->company->profile_completion)
                        <div class="tw-overflow-x-auto">
                            <ul class="nav nav-pills tw-w-[800px] tw-mx-auto justify-content-center" id="progressbar">
                            <li
